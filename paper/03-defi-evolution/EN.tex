...
\author{
  ...
  GitHub: \texttt{Shiqiang Chen}\\
  Email: \texttt{Shiqiang Chen@github}}
}
...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/03-defi-evolution/fig1-risk-index.pdf}
\caption{DeFi Risk Index: Annual Loss as \% of TVL.}
\end{figure}
...
Our 50-pattern empirical classification system, verified dataset of 824 incidents, and analysis tools are publicly available at \url{https://github.com/Shiqiang Chen/defi-hack-memo}.
