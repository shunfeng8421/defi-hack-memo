...
md_path = r"D:\ll\knowledge-base\10-security\paper\09-ai-agent-defi\CN.md"
pdf_path = r"D:\ll\knowledge-base\10-security\paper\09-ai-agent-defi\CN.pdf"
title = "当智能体开始交易：AI 智能体 x DeFi 攻击面的综合分类法"
...
print("[PDF] CN.md -> Running Chrome headless...")
result = subprocess.run(cmd, capture_output=True, text=True, timeout=90)

if os.path.exists(pdf_path):
    size_kb = os.path.getsize(pdf_path) / 1024
    lines = md_content.count('\n')
    words = len(md_content)
    print("PDF: CN.pdf (%.1f KB) | %d lines | ~%d chars" % (size_kb, lines, words))
else:
