...
PATTERNS = {
    ...
    34: {"name":"Flash Loan Governance Attack","severity":"CRITICAL","regex":[r'getVotes\\(|governance.*flash'],"keyword":["governance","propose","vote","quorum","snapshot"],"description":"Voting power based on current balance (manipulable via flash loan)","fix":"Snapshot voting power at block of proposal creation"},
